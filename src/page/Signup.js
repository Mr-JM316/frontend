  ...
  return (
    ...
    <div className='w-full max-w-sm bg-white m-auto flex flex-col p-4'>
        ...
        <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
            ...
            <input type={"email"} 
            id="email" name='email' className='mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue-300' value={data.email}
            ...
            <button className='w-full max-w-[150px] m-auto  bg-red-500 hover:bg-red-600 cursor-pointer text-white text-xl font-medium text-center py-1 rounded-full mt-4'>Signup</button>
        </form>
        <p className='text-left text mt-2'> Already have an account ?{" "}
        <Link to={"/frontend/Login"} className='text-red-500 underline'>Login</Link></p>
            </div>
            </div>
  );
}
